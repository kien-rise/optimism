        ...
        From<<L1 as ChainProvider>::Error> + From<<L2 as BatchValidationProvider>::Error>,
{
    ...
    // Construct the cursor starting at the L2 safe head's L1 origin directly.
    // No walkback needed: the pipeline reset sets the origin to l2_safe_head.l1_origin,
    // so any walked-back origin would be immediately overwritten.
